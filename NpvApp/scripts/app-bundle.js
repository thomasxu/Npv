...
define('environment',["require", "exports"], function (require, exports) {
    ...
    exports.default = {
        debug: true,
        testing: true,
        baseUrlNpvService: "http://localhost:57916/api/npv/"
    };
});
...
define('resources/elements/notification',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    ...
    ], Notification.prototype, "hasservererror", void 0);
    exports.Notification = Notification;
});

define('resources/utility/bootstrap-form-renderer',["require", "exports"], function (require, exports) {
    "use strict";
...
define('resources/models/npv-option',["require", "exports"], function (require, exports) {
    "use strict";
    var NpvOption = (function () {
        function NpvOption(inflowCount) {
            this.inflows = new Array();
    ...
    exports.NpvOption = NpvOption;
    var RateOption = (function () {
        function RateOption() {
        }
        return RateOption;
    }());
...
define('resources/models/npv-result',["require", "exports"], function (require, exports) {
    "use strict";
    var NpvResult = (function () {
        function NpvResult() {
        }
        return NpvResult;
    }());
    exports.NpvResult = NpvResult;
});
...
define('resources/services/npv-service',["require", "exports", "aurelia-fetch-client", "aurelia-framework", "../../environment"], function (require, exports, aurelia_fetch_client_1, aurelia_framework_1, appConfig) {
    "use strict";
...
define('resources/elements/npv-calculator',["require", "exports", "aurelia-framework", "aurelia-framework", "aurelia-validation", "../utility/bootstrap-form-renderer", "../models/npv-option", "../services/npv-service"], function (require, exports, aurelia_framework_1, aurelia_framework_2, aurelia_validation_1, bootstrap_form_renderer_1, npv_option_1, npv_service_1) {
    "use strict";
    var NpvCalculator = (function () {
        ...
        NpvCalculator.prototype.calculateImpl = function () {
            var _this = this;
            this.hasServerError = undefined;
        ...
        NpvCalculator.prototype.reset = function () {
            this.hasServerError = undefined;
        ...
        NpvCalculator.prototype.createCustomValidationRules = function () {
            var _this = this;
            aurelia_validation_1.ValidationRules.customRule('positiveNumber', function (value, obj) {
                var numberValue = parseFloat(value);
                return isNaN(numberValue) || numberValue > 0;
            }, "Positive number only");
            aurelia_validation_1.ValidationRules.customRule('negativeNumber', function (value, obj) {
                var numberValue = parseFloat(value);
                return isNaN(numberValue) || numberValue < 0;
            }, "Negative number only");
            aurelia_validation_1.ValidationRules.customRule('upperRateGreaterEqualToLowerRateAndPositive', function (value, obj) {
                var upperRate = parseFloat(value);
                var lowerRate = _this.npvOption.rateOption.lowerDiscount;
        ...
        NpvCalculator.prototype.applyValidationRules = function () {
            ...
            aurelia_validation_1.ValidationRules
                ...
                .on(this.npvOption);
            aurelia_validation_1.ValidationRules
                .ensure(function (opt) { return opt.lowerDiscount; })
                .satisfiesRule("positiveNumber")
                .required().withMessage(this.RequiredValidationMsg)
                .ensure(function (opt) { return opt.upperDiscount; })
                .satisfiesRule("upperRateGreaterEqualToLowerRateAndPositive")
                .required().withMessage(this.RequiredValidationMsg)
                .ensure(function (opt) { return opt.discountIncrement; })
    ...
    exports.NpvCalculator = NpvCalculator;
});
...
define('resources/elements/npv-results',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    var NpvResults = (function () {
        function NpvResults() {
        }
        return NpvResults;
    }());
    ...
    ], NpvResults.prototype, "results", void 0);
    exports.NpvResults = NpvResults;
});
...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"./resources/elements/npv-calculator\"></require><require from=\"./resources/elements/nav-bar\"></require><nav-bar router.bind=\"router\"></nav-bar><div class=\"container\"><router-view></router-view></div></template>"; });
